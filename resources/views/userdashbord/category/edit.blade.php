                          ...
                          <form action="{{route('category.update',$category->id)}}"method="POST">
                              ...
                              @method('patch')
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="exampleInputname" placeholder="Write your Catagory Name"name="name"value="{{$category->name}}">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('description') is-invalid @enderror" id="category_description" placeholder="Write your Catagory Name"name="description"value="{{$category->description}}">
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
