                          ...
                          <form action="{{route('posts.update',$post->id)}}"method="POST"enctype="multipart/form-data">
                              @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="exampleInputname" placeholder="Write your Catagory Name"name="title"value="{{$post->title}}">
                                    @error('title')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea style="color:red;"class="form-control @error('body') is-invalid @enderror" id="body" name="body"rows="5"placeholder="Your body"value="">{{$post->body}}</textarea>
                                    @error('body')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <img src='{{asset("public/uploads/$post->thumbnail")}}' alt="post images"width="140"height="80">
                                    <input type="file" 
