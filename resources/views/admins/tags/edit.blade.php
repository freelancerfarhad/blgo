                ...
                <div class="card">
                    ...
                    <div class="card-body mt-5">
                          <form action="{{route('tags.update',$tag->id)}}"method="POST">
                              ...
                              @method('patch')
                                <div class="mb-3">
                                    <label style="color:#5e5e5e"for="exampleInputname" class="form-label">Tags Name</label>
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="exampleInputname" placeholder="Write your Catagory Name"name="name"value="{{$tag->name}}">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('description') is-invalid @enderror" id="category_description" placeholder="Write your Catagory Name"name="description"value="{{$tag->description}}">
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
